                    ...
                    children: [
                                    ...
                                    label: Container(
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                              " ${controller.strDigits(controller.myDuration().inHours.remainder(60))}:${controller.strDigits(controller.myDuration().inMinutes.remainder(60))}:${controller.strDigits(controller.myDuration().inSeconds.remainder(60))}")
                                        ],
                                      ),
                                    ),
                                    isLabelVisible: true,
                      ...
                      Container(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            print('object ${controller.myDuration.value}');
                            // controller.startTimer();
                            print('object');
                            // print('DDDD*********   ${controller.formatDuration(controller.myDuration)}');
                          },
                          child: Container(
                            // width: 50,
                            margin:
                                EdgeInsets.only(left: 15, right: 220, top: 70),
