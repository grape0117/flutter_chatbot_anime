...
void main()
{
    ...
    u_xlat10_6.x = texture2D(_MainTex, u_xlat2.xy).w;
    u_xlat10_6.z = texture2D(_MainTex, u_xlat2.zw).w;
    u_xlat10_6.y = texture2D(_MainTex, u_xlat5.xy).w;
    u_xlat10_6.w = texture2D(_MainTex, u_xlat5.zw).w;
    u_xlat2 = vec4(u_xlat31) + u_xlat10_6;
    ...
    u_xlat10_0.xzw = textureCube(_Cube, u_xlat0.xzw).xyz;
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat10_2.xyz * _OutlineColor.xyz;
    u_xlat3.x = vs_COLOR0.w * _OutlineColor.w;
    u_xlat12 = u_xlat10_2.w * u_xlat3.x;
    u_xlat21.xy = vec2(_FaceUVSpeedX, _FaceUVSpeedY) * _Time.yy + vs_TEXCOORD0.zw;
    u_xlat10_4 = texture2D(_FaceTex, u_xlat21.xy);
    u_xlat5 = vs_COLOR0 * _FaceColor;
    u_xlat6 = u_xlat10_4 * u_xlat5;
    u_xlat16_10.xyz = u_xlat6.www * u_xlat6.xyz;
    u_xlat16_7.xyz = u_xlat2.xyz * vec3(u_xlat12) + (-u_xlat16_10.xyz);
    u_xlat16_7.w = u_xlat3.x * u_xlat10_2.w + (-u_xlat6.w);
    u_xlat16_1 = u_xlat16_1.xxxx * u_xlat16_7;
    u_xlat16_2.xyz = u_xlat6.xyz * u_xlat6.www + u_xlat16_1.xyz;
    u_xlat16_2.w = u_xlat5.w * u_xlat10_4.w + u_xlat16_1.w;
    u_xlat16_1.x = (-u_xlat27) * 0.5 + u_xlat9;
    ...
    u_xlat10_5.x = texture2D(_MainTex, u_xlat2.xy).w;
    u_xlat10_5.z = texture2D(_MainTex, u_xlat2.zw).w;
    u_xlat10_5.y = texture2D(_MainTex, u_xlat3.xy).w;
    u_xlat10_5.w = texture2D(_MainTex, u_xlat3.zw).w;
    u_xlat2 = u_xlat4.xxxx + u_xlat10_5;
    u_xlat2 = u_xlat2 + vec4(-0.5, -0.5, -0.5, -0.5);
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat10_2.xyz * _OutlineColor.xyz;
    u_xlat3.x = vs_COLOR0.w * _OutlineColor.w;
    u_xlat13 = u_xlat10_2.w * u_xlat3.x;
    u_xlat23.xy = vec2(_FaceUVSpeedX, _FaceUVSpeedY) * _Time.yy + vs_TEXCOORD0.zw;
    u_xlat10_4 = texture2D(_FaceTex, u_xlat23.xy);
    u_xlat5 = vs_COLOR0 * _FaceColor;
    u_xlat6 = u_xlat10_4 * u_xlat5;
    ...
    u_xlatb14 = 0.0<vs_TEXCOORD8.z;
    u_xlat16_7.x = (u_xlatb14) ? 1.0 : 0.0;
    u_xlat16_7.x = u_xlat4.x * u_xlat16_7.x;
    u_xlat4.x = dot(vs_TEXCOORD8.xyz, vs_TEXCOORD8.xyz);
...
void main()
{
    ...
    u_xlat4.x = dot(vs_TEXCOORD8.xyz, vs_TEXCOORD8.xyz);
    u_xlat4.x = texture2D(_LightTextureB0, u_xlat4.xx).x;
    u_xlat14.x = textureCube(_LightTexture0, vs_TEXCOORD8.xyz).w;
...
void main()
{
    ...
    u_xlat16_4.w = u_xlat5.w * u_xlat10_3.w + u_xlat16_2.w;
