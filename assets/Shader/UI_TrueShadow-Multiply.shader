...
void main()
{
    ...
    u_xlat1.x = (-u_xlat0.w) * vs_COLOR0.w + 1.0;
    u_xlat1.xyz = u_xlat0.xyz * vs_COLOR0.xyz + u_xlat1.xxx;
    u_xlat1.w = u_xlat0.w * vs_COLOR0.w;
    SV_Target0 = u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat2.x = (-u_xlat0.w) * u_xlat16_1 + 1.0;
    u_xlat2.xyz = u_xlat0.xyz * vec3(u_xlat16_1) + u_xlat2.xxx;
    u_xlat2.w = u_xlat16_1 * u_xlat0.w;
    SV_Target0 = u_xlat2;
    return;
}
...
void main()
{
    ...
    u_xlat0 = u_xlat10_0 + _TextureSampleAdd;
    u_xlat0 = u_xlat0 * vs_COLOR0;
    u_xlat2.x = u_xlat0.w * u_xlat16_1 + -0.00100000005;
